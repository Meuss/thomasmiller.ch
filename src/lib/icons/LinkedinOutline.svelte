<svg version="1.1" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
	><title /><desc /><defs /><g fill="none" fill-rule="evenodd" id="Page-1" stroke="none" stroke-linejoin="round" stroke-width="1"
		><g id="Linkedin" stroke="currentColor" stroke-width="3" transform="translate(1.000000, 1.000000)"
			><path
				...
				id="Stroke-18"
			/><polygon id="Stroke-19" points="7.543 49 16.231 49 16.231 21.466 7.543 21.466" /><path
